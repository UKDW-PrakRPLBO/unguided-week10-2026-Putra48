...
public class UmbrellaController implements Initializable {
    ...
    private void handleSave() {
        ...
        if (selectedItem != null) {
            try {
                ...
                Alert alert = new Alert(Alert.AlertType.ERROR, "Stock dan Supply harus berupa angka valid!");
                alert.show();
            }
        }
    }
    ...
    private void handleAdd() {
        ...
        try {
            ...
            if(itemName.isEmpty()) {
                new Alert(Alert.AlertType.ERROR, "Nama item tidak boleh kosong!").show();
                return;
            }
